...
namespace Thetis
{
    class TitleBar
    {
        public const string BUILD_NAME = "MW0LGE/wd5y pre-release";
        public const string BUILD_DATE = "(10/29/22)<FW>"; //MW0LGE_21g <FW> gets replaced in BasicTitle (console.cs) with firmware version
